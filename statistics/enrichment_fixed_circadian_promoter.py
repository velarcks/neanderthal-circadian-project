...
# in the promoter region of circadian genes using Fisher's exact test
# 
"""""""""""""""""""""""""""
...
OUTPUT_FILE = '../data/enrichment_fixed_circadian_promoter.txt'
...
# Circadian variants
def get_circadian():
    c = pd.read_csv(TSS_DIR, sep='\t', low_memory=False)
...
# --------------------------------------------------
def main():
    # FIND ALL CIRCADIAN VARIANTS IN NNaall
